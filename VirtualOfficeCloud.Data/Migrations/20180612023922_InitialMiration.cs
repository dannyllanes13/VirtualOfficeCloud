...
namespace VirtualOfficeCloud.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CellPhone = table.Column<string>(type: "varchar(25)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "getdate()"),
                    Email = table.Column<string>(type: "varchar(100)", nullable: true),
                    FamiliarName = table.Column<string>(type: "varchar(50)", nullable: true),
                    FirstName = table.Column<string>(type: "varchar(50)", nullable: true),
                    FullName = table.Column<string>(type: "varchar(101)", nullable: true, computedColumnSql: "([FirstName]+ ' ')+[LastName]"),
                    ...
                    SinSsn = table.Column<string>(type: "varchar(50)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AccessLevel = table.Column<string>(type: "varchar(70)", nullable: true),
